...
<body>
	...
	<form id="check" action="mail" method="post">
		<h2>Mail</h2>
		...
		<div class="row100">
			<div class="col">
				<div class="inputBox">
					<input type="text" name="name" required> <span class="text">Name</span>
					<span class="line"></span>
				</div>
			</div>
			<div class="col">
				<div class="inputBox">
					<input type="text" name="phno" id="phno" required> <span
		...
		<div class="row100">
			<div class="col">
				<div class="inputBox">
					<input type="text" name="msg" required> <span class="text">Message</span>
					<span class="line"></span>
				</div>
			</div>
		</div>
		...
		<div class="row100">
			<div class="col">
				<input type="submit" id="subimt" value="Send Mail">
			</div>
		</div>
